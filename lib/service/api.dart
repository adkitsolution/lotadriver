...
class API {
  static const baseUrl = "https://lotaride.ca/api/v1/"; // live
  static const apiKey = "base64:AvWCkJvAvciKL8Ctgjr59t4hDBCrEDdfvLnr6XHF0Gs=";
  ...
  static const driverAllRides = "${baseUrl}driver-all-rides";// this one
