...
class WalletScreen extends StatelessWidget {
                            ...
                            child: Text(
                              data.amount!.toString().contains('-')
                                  ...
                                  : data.amount!.isNotEmpty
                                      ...
                                      : "",
                              style: TextStyle(fontWeight: FontWeight.bold, color: data.amount!.toString().contains('-') ? Colors.red : ConstantColors.primary),
                            ),
                          )
                                ...
                                child: Text(
                                  data.transactionAmount!.toString().contains('-')
                                      ...
                                      : data.transactionAmount!.isNotEmpty
                                          ...
                                          : "",
                                  style: TextStyle(fontWeight: FontWeight.bold, color: data.transactionAmount!.toString().contains('-') ? Colors.red : ConstantColors.primary),
                                ),
                              )
                            : Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 4.0),
                      ...
                      ? Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                data.transactionAmount!.toString().contains('-') ? "Admin Commission".tr : data.payment.toString(),
                                style: TextStyle(color: ConstantColors.yellow, fontWeight: FontWeight.bold),
                              )
                            ],
                          ))
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration:
                            BoxDecoration(border: Border.all(color: ConstantColors.primary.withOpacity(0.40), width: 4), borderRadius: const BorderRadius.all(Radius.circular(20))),
                        child: Padding(
                            ...
                            onPress: () async {
                              if (controller.bankDetails.bankName.toString() != 'null') {
                                if (amountController.text.isNotEmpty) {
                                  if (double.parse(Constant.minimumWithdrawalAmount.toString()) > double.parse(amountController.text)) {
  ...
  void initPayPal() async {
    ...
    await _flutterPaypalNativePlugin.init(
      ...
      returnUrl: "com.lotadriver.adk://paypalpay",
  ...
  flutterWaveInitiatePayment(BuildContext context) async {
